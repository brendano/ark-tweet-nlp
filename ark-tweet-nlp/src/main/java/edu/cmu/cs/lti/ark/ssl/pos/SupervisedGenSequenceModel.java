...
public class SupervisedGenSequenceModel extends GradientSequenceModel {
	...
	public SupervisedForwardBackwardGen forwardBackward;
	private int[][] goldLabels;
	
	public SupervisedGenSequenceModel(int[][] observations0, 
									int[][] goldLabels0,
									int numLabels0, 
		...
		this.forwardBackward = new SupervisedForwardBackwardGen(observations, 
				goldLabels,
				numLabels0, 
				numObservations, 
				transProbs, 
	...
	public void setActiveFeatures(List<Pair<Integer,Double>>[][] activeTransFeatures0, 
								  List<Pair<Integer,Double>>[][] activeEmitFeatures0, 
								  List<Pair<Integer,Double>>[][] activeStackedFeatures,
								  int numFeatures0, 
